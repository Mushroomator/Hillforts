...
class HillfortImagesAdapter constructor(
    private var images: List<String>,
    private var listener: HillfortImageListener)
    : RecyclerView.Adapter<HillfortImagesAdapter.MainHolder>() {
    ...
    override fun getItemCount(): Int {
        // max of 4 images
        if(images.size > R.integer.max_images){
            return R.integer.max_images
        }
        return images.size
    }
    ...
    class MainHolder constructor(itemView: View): RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(image: String, index: Int,listener: HillfortImageListener){
            Glide.with(itemView.context).load(image).into(itemView.ivHillfortImage)
